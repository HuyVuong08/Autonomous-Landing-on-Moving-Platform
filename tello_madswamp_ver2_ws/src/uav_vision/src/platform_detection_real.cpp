...
public:
    ...
    void height(const geometry_msgs::PointStampedConstPtr& msg);
...
Platform_Detection::Platform_Detection()
{
    ...
    //For Tello
    nh_.param("image_topic", image_topic_, std::string("/drone0/sensor_measurement/camera/image_raw"));
    nh_.param("cam_info_topic", camera_info_topic_, std::string("/drone0/sensor_measurement/camera/camera_info"));
    nh_.param("platform_position_topic", platform_position_topic_, std::string("/platform/estimated_position"));
    nh_.param("tello_altitude_topic", tello_altitude_topic_, std::string("/drone0/sensor_measurement/altitude"));
    nh_.param("imu_topic", imu_topic_, std::string("/drone0/sensor_measurement/imu"));
...
void Platform_Detection::height(const geometry_msgs::PointStampedConstPtr& msg)
{
    altitude_quadrotor = msg->point.z; 
}
