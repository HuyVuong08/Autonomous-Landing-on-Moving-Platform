...
echo_and_run cd "/home/huy/Autonomous-Landing-on-Moving-Platform/pablo_uav_system_ws/src/thirdparty/vision_opencv/cv_bridge"
...
echo_and_run /usr/bin/env \
    ...
    "/home/huy/Autonomous-Landing-on-Moving-Platform/pablo_uav_system_ws/src/thirdparty/vision_opencv/cv_bridge/setup.py" \
     \
    build --build-base "/home/huy/Autonomous-Landing-on-Moving-Platform/pablo_uav_system_ws/build/thirdparty/vision_opencv/cv_bridge" \
    install \
    --root="${DESTDIR-/}" \
