...
class ArdroneActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ArdroneGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ArdroneActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = ArdroneGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new ArdroneGoal()
    }
...
module.exports = ArdroneActionGoal;
