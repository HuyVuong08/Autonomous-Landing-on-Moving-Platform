...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'teleop_twist_keyboard' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/datrg/Autonomous-Landing-on-Moving-Platform/catkin_ws/src/teleop_twist_keyboard/${idir}'.  ${_report}")
    endif()
