...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<LedAnim-request>)))
  ...
  (cl:format cl:nil "# 0 : BLINK_GREEN_RED~%# 1 : BLINK_GREEN~%# 2 : BLINK_RED~%# 3 : BLINK_ORANGE~%# 4 : SNAKE_GREEN_RED~%# 5 : FIRE~%# 6 : STANDARD~%# 7 : RED~%# 8 : GREEN~%# 9 : RED_SNAKE~%# 10: BLANK~%# 11: LEFT_GREEN_RIGHT_RED~%# 12: LEFT_RED_RIGHT_GREEN~%# 13: BLINK_STANDARD~%uint8 type~%~%# In Hz~%float32 freq~%~%# In Seconds~%uint8 duration ~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'LedAnim-request)))
  "Returns full string definition for message of type 'LedAnim-request"
  (cl:format cl:nil "# 0 : BLINK_GREEN_RED~%# 1 : BLINK_GREEN~%# 2 : BLINK_RED~%# 3 : BLINK_ORANGE~%# 4 : SNAKE_GREEN_RED~%# 5 : FIRE~%# 6 : STANDARD~%# 7 : RED~%# 8 : GREEN~%# 9 : RED_SNAKE~%# 10: BLANK~%# 11: LEFT_GREEN_RIGHT_RED~%# 12: LEFT_RED_RIGHT_GREEN~%# 13: BLINK_STANDARD~%uint8 type~%~%# In Hz~%float32 freq~%~%# In Seconds~%uint8 duration ~%~%~%~%"))
