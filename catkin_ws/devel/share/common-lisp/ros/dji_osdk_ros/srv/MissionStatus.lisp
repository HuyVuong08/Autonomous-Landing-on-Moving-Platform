...
(cl:defmethod cl:initialize-instance :after ((m <MissionStatus-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MissionStatus-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dji_osdk_ros-srv:<MissionStatus-request> is deprecated: use dji_osdk_ros-srv:MissionStatus-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MissionStatus-request>)))
  ...
  "dji_osdk_ros/MissionStatusRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MissionStatus-request)))
  "Returns string type for a service object of type 'MissionStatus-request"
  "dji_osdk_ros/MissionStatusRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <MissionStatus-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MissionStatus-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dji_osdk_ros-srv:<MissionStatus-response> is deprecated: use dji_osdk_ros-srv:MissionStatus-response instead.")))
...
(cl:defmethod waypoint_mission_count-val ((m <MissionStatus-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dji_osdk_ros-srv:waypoint_mission_count-val is deprecated.  Use dji_osdk_ros-srv:waypoint_mission_count instead.")
...
(cl:defmethod hotpoint_mission_count-val ((m <MissionStatus-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dji_osdk_ros-srv:hotpoint_mission_count-val is deprecated.  Use dji_osdk_ros-srv:hotpoint_mission_count instead.")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MissionStatus-response>)))
  ...
  "dji_osdk_ros/MissionStatusResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MissionStatus-response)))
  "Returns string type for a service object of type 'MissionStatus-response"
  "dji_osdk_ros/MissionStatusResponse")
