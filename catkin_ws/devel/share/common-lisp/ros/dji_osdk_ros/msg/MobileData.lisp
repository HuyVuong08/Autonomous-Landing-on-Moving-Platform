...
(cl:defmethod cl:initialize-instance :after ((m <MobileData>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MobileData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dji_osdk_ros-msg:<MobileData> is deprecated: use dji_osdk_ros-msg:MobileData instead.")))
