...
(cl:defclass <MissionWaypointTask> (roslisp-msg-protocol:ros-message)
  ((velocity_range
   ...
   (mission_waypoint
    ...
    :type (cl:vector dji_osdk_ros-msg:MissionWaypoint)
   :initform (cl:make-array 0 :element-type 'dji_osdk_ros-msg:MissionWaypoint :initial-element (cl:make-instance 'dji_osdk_ros-msg:MissionWaypoint))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <MissionWaypointTask>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MissionWaypointTask)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dji_osdk_ros-msg:<MissionWaypointTask> is deprecated: use dji_osdk_ros-msg:MissionWaypointTask instead.")))

(cl:ensure-generic-function 'velocity_range-val :lambda-list '(m))
(cl:defmethod velocity_range-val ((m <MissionWaypointTask>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dji_osdk_ros-msg:velocity_range-val is deprecated.  Use dji_osdk_ros-msg:velocity_range instead.")
  (velocity_range m))

(cl:ensure-generic-function 'idle_velocity-val :lambda-list '(m))
(cl:defmethod idle_velocity-val ((m <MissionWaypointTask>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dji_osdk_ros-msg:idle_velocity-val is deprecated.  Use dji_osdk_ros-msg:idle_velocity instead.")
  (idle_velocity m))

(cl:ensure-generic-function 'action_on_finish-val :lambda-list '(m))
(cl:defmethod action_on_finish-val ((m <MissionWaypointTask>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dji_osdk_ros-msg:action_on_finish-val is deprecated.  Use dji_osdk_ros-msg:action_on_finish instead.")
  (action_on_finish m))

(cl:ensure-generic-function 'mission_exec_times-val :lambda-list '(m))
(cl:defmethod mission_exec_times-val ((m <MissionWaypointTask>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dji_osdk_ros-msg:mission_exec_times-val is deprecated.  Use dji_osdk_ros-msg:mission_exec_times instead.")
  (mission_exec_times m))

(cl:ensure-generic-function 'yaw_mode-val :lambda-list '(m))
(cl:defmethod yaw_mode-val ((m <MissionWaypointTask>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dji_osdk_ros-msg:yaw_mode-val is deprecated.  Use dji_osdk_ros-msg:yaw_mode instead.")
  (yaw_mode m))

(cl:ensure-generic-function 'trace_mode-val :lambda-list '(m))
(cl:defmethod trace_mode-val ((m <MissionWaypointTask>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dji_osdk_ros-msg:trace_mode-val is deprecated.  Use dji_osdk_ros-msg:trace_mode instead.")
  (trace_mode m))

(cl:ensure-generic-function 'action_on_rc_lost-val :lambda-list '(m))
(cl:defmethod action_on_rc_lost-val ((m <MissionWaypointTask>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dji_osdk_ros-msg:action_on_rc_lost-val is deprecated.  Use dji_osdk_ros-msg:action_on_rc_lost instead.")
  (action_on_rc_lost m))

(cl:ensure-generic-function 'gimbal_pitch_mode-val :lambda-list '(m))
(cl:defmethod gimbal_pitch_mode-val ((m <MissionWaypointTask>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dji_osdk_ros-msg:gimbal_pitch_mode-val is deprecated.  Use dji_osdk_ros-msg:gimbal_pitch_mode instead.")
  (gimbal_pitch_mode m))

(cl:ensure-generic-function 'mission_waypoint-val :lambda-list '(m))
(cl:defmethod mission_waypoint-val ((m <MissionWaypointTask>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dji_osdk_ros-msg:mission_waypoint-val is deprecated.  Use dji_osdk_ros-msg:mission_waypoint instead.")
  (mission_waypoint m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MissionWaypointTask>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'mission_waypoint)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'dji_osdk_ros-msg:MissionWaypoint))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MissionWaypointTask>)))
  ...
  "dji_osdk_ros/MissionWaypointTask")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MissionWaypointTask)))
  "Returns string type for a message object of type 'MissionWaypointTask"
  "dji_osdk_ros/MissionWaypointTask")
