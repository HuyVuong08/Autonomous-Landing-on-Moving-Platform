...
(cl:defmethod cl:initialize-instance :after ((m <PayloadData>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PayloadData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dji_osdk_ros-msg:<PayloadData> is deprecated: use dji_osdk_ros-msg:PayloadData instead.")))
