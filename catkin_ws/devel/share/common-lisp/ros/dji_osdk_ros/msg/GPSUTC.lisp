...
(cl:defmethod cl:initialize-instance :after ((m <GPSUTC>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GPSUTC)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dji_osdk_ros-msg:<GPSUTC> is deprecated: use dji_osdk_ros-msg:GPSUTC instead.")))
...
(cl:defmethod UTCTimeData-val ((m <GPSUTC>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dji_osdk_ros-msg:UTCTimeData-val is deprecated.  Use dji_osdk_ros-msg:UTCTimeData instead.")
  (UTCTimeData m))
