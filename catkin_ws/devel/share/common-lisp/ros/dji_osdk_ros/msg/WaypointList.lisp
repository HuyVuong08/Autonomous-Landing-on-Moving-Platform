...
(cl:defclass <WaypointList> (roslisp-msg-protocol:ros-message)
  ((waypoint_list
    ...
    :type (cl:vector dji_osdk_ros-msg:Waypoint)
   :initform (cl:make-array 0 :element-type 'dji_osdk_ros-msg:Waypoint :initial-element (cl:make-instance 'dji_osdk_ros-msg:Waypoint))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <WaypointList>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WaypointList)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dji_osdk_ros-msg:<WaypointList> is deprecated: use dji_osdk_ros-msg:WaypointList instead.")))

(cl:ensure-generic-function 'waypoint_list-val :lambda-list '(m))
(cl:defmethod waypoint_list-val ((m <WaypointList>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dji_osdk_ros-msg:waypoint_list-val is deprecated.  Use dji_osdk_ros-msg:waypoint_list instead.")
  (waypoint_list m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <WaypointList>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'waypoint_list)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'dji_osdk_ros-msg:Waypoint))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<WaypointList>)))
  ...
  (cl:format cl:nil "Waypoint[] waypoint_list~%~%================================================================================~%MSG: dji_osdk_ros/Waypoint~%float64 latitude      # in degree~%float64 longitude     # in degree~%float32 altitude~%int16 heading         #heading is in [-180,180]~%uint16 staytime       # in second~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'WaypointList)))
  "Returns full string definition for message of type 'WaypointList"
  (cl:format cl:nil "Waypoint[] waypoint_list~%~%================================================================================~%MSG: dji_osdk_ros/Waypoint~%float64 latitude      # in degree~%float64 longitude     # in degree~%float32 altitude~%int16 heading         #heading is in [-180,180]~%uint16 staytime       # in second~%~%~%~%"))
