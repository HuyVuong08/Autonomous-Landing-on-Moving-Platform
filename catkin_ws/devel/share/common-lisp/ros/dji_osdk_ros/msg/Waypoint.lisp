...
(cl:defmethod cl:initialize-instance :after ((m <Waypoint>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Waypoint)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dji_osdk_ros-msg:<Waypoint> is deprecated: use dji_osdk_ros-msg:Waypoint instead.")))
...
(cl:defmethod staytime-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dji_osdk_ros-msg:staytime-val is deprecated.  Use dji_osdk_ros-msg:staytime instead.")
  (staytime m))
