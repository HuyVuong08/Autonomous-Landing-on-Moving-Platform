...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_feedback.feedback.lastImage.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.action_feedback.feedback.lastImage.format = str[start:end].decode('utf-8', 'rosmsg')
      else:
