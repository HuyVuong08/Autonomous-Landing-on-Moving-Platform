...
class TelloStatus {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.uint8(obj.wifi_strength, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.wifi_strength = _deserializer.uint8(buffer, bufferOffset);
  ...
  static md5sum() {
    ...
    return 'af6eaa07adf37504b6f69343ccf5fec4';
  }
