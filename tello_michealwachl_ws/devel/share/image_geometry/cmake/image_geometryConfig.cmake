...
if("TRUE" STREQUAL "TRUE")
  set(image_geometry_SOURCE_PREFIX /home/tello1804/Autonomous-Landing-on-Moving-Platform/tello_michealwachl_ws/src/vision_opencv/image_geometry)
  set(image_geometry_DEVEL_PREFIX /home/tello1804/Autonomous-Landing-on-Moving-Platform/tello_michealwachl_ws/devel)
  ...
  set(image_geometry_INSTALL_PREFIX /home/tello1804/Autonomous-Landing-on-Moving-Platform/tello_michealwachl_ws/install)
...
if(NOT "/home/tello1804/Autonomous-Landing-on-Moving-Platform/tello_michealwachl_ws/src/vision_opencv/image_geometry/include;/usr/include;/usr/include/opencv " STREQUAL " ")
  set(image_geometry_INCLUDE_DIRS "")
  set(_include_dirs "/home/tello1804/Autonomous-Landing-on-Moving-Platform/tello_michealwachl_ws/src/vision_opencv/image_geometry/include;/usr/include;/usr/include/opencv")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_geometry' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tello1804/Autonomous-Landing-on-Moving-Platform/tello_michealwachl_ws/src/vision_opencv/image_geometry/${idir}'.  ${_report}")
    endif()
