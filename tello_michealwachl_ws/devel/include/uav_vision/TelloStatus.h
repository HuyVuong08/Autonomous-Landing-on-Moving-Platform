// Generated by gencpp from file uav_vision/TelloStatus.msg
// DO NOT EDIT!


#ifndef UAV_VISION_MESSAGE_TELLOSTATUS_H
#define UAV_VISION_MESSAGE_TELLOSTATUS_H
...
struct TelloStatus_
{
  ...
  typedef boost::shared_ptr< ::uav_vision::TelloStatus_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::uav_vision::TelloStatus_<ContainerAllocator> const> ConstPtr;

}; // struct TelloStatus_

typedef ::uav_vision::TelloStatus_<std::allocator<void> > TelloStatus;

typedef boost::shared_ptr< ::uav_vision::TelloStatus > TelloStatusPtr;
typedef boost::shared_ptr< ::uav_vision::TelloStatus const> TelloStatusConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::uav_vision::TelloStatus_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::uav_vision::TelloStatus_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::uav_vision::TelloStatus_<ContainerAllocator1> & lhs, const ::uav_vision::TelloStatus_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::uav_vision::TelloStatus_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::uav_vision::TelloStatus_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::uav_vision::TelloStatus_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::uav_vision::TelloStatus_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::uav_vision::TelloStatus_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::uav_vision::TelloStatus_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::uav_vision::TelloStatus_<ContainerAllocator> >
{
  ...
  static const char* value(const ::uav_vision::TelloStatus_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xe6d1629583c9b3a3ULL;
  static const uint64_t static_value2 = 0x37a806afc71e19f7ULL;
};

template<class ContainerAllocator>
struct DataType< ::uav_vision::TelloStatus_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::uav_vision::TelloStatus_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::uav_vision::TelloStatus_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::uav_vision::TelloStatus_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::uav_vision::TelloStatus_<ContainerAllocator>& v)
  {
    s << indent << "height_m: ";
...
#endif // UAV_VISION_MESSAGE_TELLOSTATUS_H
