...
echo_and_run cd "/home/tello1804/tello_michealwachl_ws/src/autonomous_drone_plant_detection/tello_driver"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/tello1804/tello_michealwachl_ws/src/autonomous_drone_plant_detection/tello_driver/setup.py" \
     \
    build --build-base "/home/tello1804/tello_michealwachl_ws/build/autonomous_drone_plant_detection/tello_driver" \
    install \
    --root="${DESTDIR-/}" \
