...
echo_and_run cd "/home/tello1804/tello_michealwachl_ws/src/vision_opencv/image_geometry"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/tello1804/tello_michealwachl_ws/src/vision_opencv/image_geometry/setup.py" \
     \
    build --build-base "/home/tello1804/tello_michealwachl_ws/build/vision_opencv/image_geometry" \
    install \
    --root="${DESTDIR-/}" \
